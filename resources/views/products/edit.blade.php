                                ...
                                <div class="form-group row pt-3">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text"
                                               name="product[oem]" value="{{$product->oem}}">
                                    </div>
                                </div>
                                <div class="form-group row pt-3">
                                    ...
                                    <div class="col-md-4">
                                        <input class="form-control" type="text"
                                               name="product[model_no]" value="{{$product->model_no}}">
                                    </div>
                                </div>
                                <div class="form-group row pt-3">
                                    <label for="image"
                                    ...
                                    <div class="col-md-4">
                                        <select class="form-control" name="product[product_type]" value="{{$product->product_type}}">
                                ...
                                <div class="form-group row pt-3">
                                    ...
                                    <div class="col-lg-7">
                                        <textarea class="form-control"
                                               name="product[config]"
                                               value="{{$product->config}}">{{$product->config}}</textarea>
                                    </div>
                                </div>
